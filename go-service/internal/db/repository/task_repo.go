...
func (r *TaskRepository) CreateSubmission(taskID int64, resultContent, resultFileURL, resultHash string) error {
	...
	_, err := r.db.Exec(`
        INSERT INTO task_submissions (task_id, result_content, result_file_url, result_hash)
        VALUES ($1, $2, $3, $4)
    `, taskID, resultContent, fileURL, hash)
