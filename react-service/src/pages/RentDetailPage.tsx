            ...
            <main className="mx-auto flex w-full max-w-[960px] flex-col gap-8 px-6 py-12 md:px-12">
                ...
                <section className="rounded-2xl border border-outline-variant/15 bg-surface-container-lowest p-8">
                    ...
                    <dl className="grid gap-4 md:grid-cols-2">
                        ...
                        <InfoRow label="可養寵物" value={listing.allow_pets ? "是" : "否"} />
                        <InfoRow label="可炊煮" value={listing.allow_cooking ? "是" : "否"} />
                        {listing.gender_restriction ? <InfoRow label="性別限制" value={listing.gender_restriction} /> : null}
